...
downloads:
  uxnds043.zip:
    size: 400292
    size_str: 390 KiB
    url: https://github.com/asiekierka/uxnds/releases/download/v0.4.3/uxnds043.zip
...
update_notes: '<ul dir="auto">
  ...
  <li>[3DS] Update to libctru 2.2.2.</li>

  <li>[3DS] Optimize and fix bugs in the screen device implementation.</li>

  </ul>

  <p dir="auto">No changes to the NDS version.</p>'
updated: '2023-05-08T21:06:41Z'
version: v0.4.3
version_title: uxnds 0.4.3
