...
downloads:
  NitrousTracker-0.7.0b4-n3ds.zip:
    size: 1891649
    size_str: 1 MiB
    url: https://codeberg.org/NitrousTracker/nitroustracker/releases/download/release%2F0.7.0b4/NitrousTracker-0.7.0b4-n3ds.zip
  NitrousTracker-0.7.0b4-nds.zip:
    size: 2558097
    size_str: 2 MiB
    url: https://codeberg.org/NitrousTracker/nitroustracker/releases/download/release%2F0.7.0b4/NitrousTracker-0.7.0b4-nds.zip
...
update_notes: '<p><strong>This is a beta release!</strong> Report any issues found
  ...
  <li>note: this may require tweaks to old songs which depended on NitroTracker play
  routine quirks. some
  ...
  <li>NDS: updated BlocksDS to 1.23.0</li>
  ...
  <li>fixed file corruption when out of memory and trying to save .xm files with 8-bit
  samples</li>

  </ul>

  '
updated: '2026-08-30T05:13:29Z'
version: release/0.7.0b4
version_title: NitrousTracker v0.7.0 beta 4
...
<details class="alert alert-secondary"><summary>nitroustracker.3dsx</summary>
<ol>
<li>Download <code>NitrousTracker-0.7.0b4-n3ds.zip</code></li>
