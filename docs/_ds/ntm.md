...
downloads:
  NTM.dsi:
    size: 160256
    size_str: 156 KiB
    url: https://github.com/Epicpkmn11/NTM/releases/download/v0.5.1/NTM.dsi
...
update_notes: '<p dir="auto">Whoops, one change slipped through the cracks on the
  last release... Thank you to <a class="user-mention notranslate" data-hovercard-type="user"
  data-hovercard-url="/users/Sumrak-Sumarokov/hovercard" data-octo-click="hovercard-link-click"
  data-octo-dimensions="link_type:self" href="https://github.com/Sumrak-Sumarokov">@Sumrak-Sumarokov</a>
  for reporting it!</p>

  <p dir="auto">Titles can now be deleted from SDNAND again as normal.</p>'
updated: '2026-06-24T02:02:11Z'
version: v0.5.1
version_title: Fixed deleting from SDNAND
