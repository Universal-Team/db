...
downloads:
  CTGP7SaveTransfer.3dsx:
    size: 740224
    size_str: 722 KiB
    url: https://github.com/CyberYoshi64/CTGP7-SaveTransfer/releases/download/v0.2/CTGP7SaveTransfer.3dsx
  CTGP7SaveTransfer.cia:
    size: 1061824
    size_str: 1 MiB
    url: https://github.com/CyberYoshi64/CTGP7-SaveTransfer/releases/download/v0.2/CTGP7SaveTransfer.cia
...
update_notes: '<p dir="auto">You have more options for the transfer!</p>

  <ul dir="auto">

  <li>Omit transferring your statistics (such as regular VR and the stats in MK Channel)!</li>

  <li>Pick individual ghosts to transfer! (if the source has any)</li>

  </ul>'
updated: '2022-08-12T22:19:57Z'
version: v0.2
version_title: The More Control update
---
