...
<li>Extract <code>/3ds/randomtitlepicker/3ds-randomtitlepicker.3dsx</code> from the release.zip to <code>/3ds/3ds-randomtitlepicker.3dsx</code> on your SD card</li>
</ol>
</details>
