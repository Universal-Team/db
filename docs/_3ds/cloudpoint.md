...
prerelease:
  download_page: https://github.com/dwalker109/cloudpoint/releases/tag/0.7.0
  downloads:
    cloudpoint.3dsx:
      size: 2923416
      size_str: 2 MiB
  ...
  update_notes: '<p dir="auto">Some nice UI polish and various bugfixes collected
    over the last few weeks.</p>

    <p dir="auto">As always, it is best to run a full Auto Sync <strong>before updating</strong>
    and again after. This just makes the need to resolve conflicts (caused by some
    internal changes to DB formats) less likely - if a sync is a "no op" Cloudpoint
    can usually just do whatever internal stuff it needs to without asking you.</p>
    ...
    data-id="5101856083" data-permission-text="Title is private" data-url="https://github.com/dwalker109/cloudpoint/issues/132"
    ...
    data-octo-dimensions="link_type:self" href="https://github.com/dwalker109">@dwalker109</a>
    in <a class="issue-link js-issue-link" data-error-text="Failed to load title"
    data-id="5102061693" data-permission-text="Title is private" data-url="https://github.com/dwalker109/cloudpoint/issues/133"
    ...
    in <a class="issue-link js-issue-link" data-error-text="Failed to load title"
    data-id="5102101786" data-permission-text="Title is private" data-url="https://github.com/dwalker109/cloudpoint/issues/134"
    ...
    data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="https://github.com/dwalker109">@dwalker109</a>
    in <a class="issue-link js-issue-link" data-error-text="Failed to load title"
    data-id="5102533872" data-permission-text="Title is private" data-url="https://github.com/dwalker109/cloudpoint/issues/136"
    ...
    data-octo-dimensions="link_type:self" href="https://github.com/dwalker109">@dwalker109</a>
    in <a class="issue-link js-issue-link" data-error-text="Failed to load title"
    data-id="5102599750" data-permission-text="Title is private" data-url="https://github.com/dwalker109/cloudpoint/issues/138"
  ...
  update_notes_md: 'Some nice UI polish and various bugfixes collected over the last
    few weeks.


    As always, it is best to run a full Auto Sync **before updating** and again after.
    This just makes the need to resolve conflicts (caused by some internal changes
    to DB formats) less likely - if a sync is a "no op" Cloudpoint can usually just
    do whatever internal stuff it needs to without asking you.


    ## What''s Changed

    * A little UI love by @dwalker109 in https://github.com/dwalker109/cloudpoint/pull/132

    * Update to new production API host URL by @dwalker109 in https://github.com/dwalker109/cloudpoint/pull/133

    * Do not sync abort when title meta versions do not match (unreliable signal)
    by @dwalker109 in https://github.com/dwalker109/cloudpoint/pull/134

    * Install history db does not correctly handle title with savedata and extdata
    by @dwalker109 in https://github.com/dwalker109/cloudpoint/pull/136

    * Auto sync titles in title_short order by @dwalker109 in https://github.com/dwalker109/cloudpoint/pull/138



    **Full Changelog**: https://github.com/dwalker109/cloudpoint/compare/0.6.0...0.7.0'
