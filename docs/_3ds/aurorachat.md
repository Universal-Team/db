...
downloads:
  aurorachat.3dsx:
    size: 4997780
    size_str: 4 MiB
    url: https://github.com/Unitendo/aurorachat/releases/download/v0.6.0.5/aurorachat.3dsx
  aurorachat.cia:
    size: 5542848
    size_str: 5 MiB
    url: https://github.com/Unitendo/aurorachat/releases/download/v0.6.0.5/aurorachat.cia
...
unique_ids:
- '0xBAFD2'
update_notes: '<p dir="auto">Added support for custom BGM.<br>

  Requirements for custom BGM:<br>

  Mono, 16-bit 22.050 kHz (22050 Hz) WAV saved at the root of your SD card as "auc.wav"</p>'
updated: '2026-06-09T00:21:44Z'
version: v0.6.0.5
version_title: 'v0.6.0.5: Custom BGM! Also Orstando Why Did You Call The Last One
  v6 Instead Of v0.6'
---
