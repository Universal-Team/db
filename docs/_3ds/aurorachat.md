...
downloads:
  aurorachat.3dsx:
    size: 4997804
    size_str: 4 MiB
    url: https://github.com/Unitendo/aurorachat/releases/download/v6.0.4/aurorachat.3dsx
  aurorachat.cia:
    size: 5555136
    size_str: 5 MiB
    url: https://github.com/Unitendo/aurorachat/releases/download/v6.0.4/aurorachat.cia
...
unique_ids:
- '0xBAFD2'
update_notes: <p dir="auto">Changes audio stuff and fixes spacing issues.</p>
updated: '2026-06-04T06:34:43Z'
version: v6.0.4
version_title: 'v6.0.4: Audio/Spacing'
---
