...
downloads:
  red-viper.3dsx:
    size: 629580
    size_str: 614 KiB
    url: https://github.com/skyfloogle/red-viper/releases/download/v1.1.2/red-viper.3dsx
  red-viper.cia:
    size: 668608
    size_str: 652 KiB
    url: https://github.com/skyfloogle/red-viper/releases/download/v1.1.2/red-viper.cia
...
unique_ids:
- '0xFE7CB'
update_notes: <p dir="auto">This release fixes a bug introduced in v1.1.0 where savestates
  from prior versions could no longer be loaded.</p>
updated: '2025-09-23T22:18:31Z'
version: v1.1.2
