...
downloads:
  magic-draw.3dsx:
    size: 529624
    size_str: 517 KiB
    url: https://github.com/natsuneco/magic-draw/releases/download/v1.0.0/magic-draw.3dsx
  magic-draw.cia:
    size: 611264
    size_str: 596 KiB
    url: https://github.com/natsuneco/magic-draw/releases/download/v1.0.0/magic-draw.cia
...
unique_ids:
- '0xCF024'
update_notes: <p dir="auto">RELEASE!!!!!!!</p>
