...
downloads:
  scratch-3ds.3dsx:
    size: 10003732
    size_str: 9 MiB
    url: https://github.com/ScratchEverywhere/ScratchEverywhere/releases/download/0.30.1/scratch-3ds.3dsx
  scratch-3ds.cia:
    size: 8942528
    size_str: 8 MiB
    url: https://github.com/ScratchEverywhere/ScratchEverywhere/releases/download/0.30.1/scratch-3ds.cia
  scratch-ds.nds:
    size: 4444160
    size_str: 4 MiB
...
update_notes: '<p dir="auto"><strong>This is an emergency release for yesterday''s
  ...
  <li>Fixed a bug causing projects to not get found in the Main Menu on some devices</li>

  <li>Fixed being able to click Sprites while they''re hidden</li>

  </ul>'
updated: '2025-12-01T15:03:29Z'
version: 0.30.1
version_title: Beta Build 30.1
