...
downloads:
  Vapecord.Public.zip:
    size: 4254836
    size_str: 4 MiB
    url: https://github.com/RedShyGuy/Vapecord-ACNL-Plugin/releases/download/v3.0.1/Vapecord.Public.zip
...
update_notes: '<h1 dir="auto">First Hotfix Version!</h1>

  <h2 dir="auto">Bug Fixes</h2>

  <ul dir="auto">

  <li>Fixed Building Mod not working</li>

  <li>Fixed Insect Spawner Crashing</li>

  <li>Fixed Too Long OSD Messages Overflowing (Now Wraps Text)</li>

  <li>Disabled Dev Codes in release (oops)</li>
...
updated: '2026-02-11T12:33:33Z'
version: v3.0.1
version_title: ACNL Vapecord Public Plugin [v.3.0.1]
