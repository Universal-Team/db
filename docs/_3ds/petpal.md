...
downloads:
  PetPal.3dsx:
    size: 31204276
    size_str: 29 MiB
    url: https://github.com/PetPal-Team/PetPal/releases/download/v0.1.1/PetPal.3dsx
  PetPal.cia:
    size: 31388608
    size_str: 29 MiB
    url: https://github.com/PetPal-Team/PetPal/releases/download/v0.1.1/PetPal.cia
...
unique_ids:
- '0xF00D5'
update_notes: <h1 dir="auto">Fixed Title ID</h1>
updated: '2026-07-04T21:37:23Z'
version: v0.1.1
version_title: PetPal v0.1.1 Public | Fixed Title ID
