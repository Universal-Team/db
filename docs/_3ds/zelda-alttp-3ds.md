...
preinstall_message: Place a legally obtained USA, unheadered ROM in sdmc:/3ds/Zelda
  ...
  or .smc filenames.
prerelease:
  download_page: https://github.com/EstebanPdN/zelda-alttp-3ds/releases/tag/v3.2-E2
  downloads:
    zelda3-3ds-v3.2-E2.3dsx:
      size: 6756348
      size_str: 6 MiB
      url: https://github.com/EstebanPdN/zelda-alttp-3ds/releases/download/v3.2-E2/zelda3-3ds-v3.2-E2.3dsx
    zelda3-3ds-v3.2-E2.cia:
      size: 5944256
      size_str: 5 MiB
      url: https://github.com/EstebanPdN/zelda-alttp-3ds/releases/download/v3.2-E2/zelda3-3ds-v3.2-E2.cia
  qr:
    zelda3-3ds-v3.2-E2.cia: https://db.universal-team.net/assets/images/qr/prerelease/zelda3-3ds-v3-2-e2-cia.png
  update_notes: '<div class="markdown-alert markdown-alert-warning" dir="auto"><p
    ...
    <p dir="auto"><a target="_blank" rel="noopener noreferrer" href="https://github.com/EstebanPdN/zelda-alttp-3ds/releases/download/v3.2-E2/QR-v3.2-E2-github.png"><img
    width="490" height="490" alt="QR code for the v3.2-E2 CIA" src="https://github.com/EstebanPdN/zelda-alttp-3ds/releases/download/v3.2-E2/QR-v3.2-E2-github.png"
    ...
    <li>Optimized update downloads and installation.</li>

    <li>Fixed black screens and missing audio after Restart and ROM reselection.</li>
    ...
    is visible and attach the complete diagnostic dump folder from:</p>
  ...
  update_notes_md: '> [!WARNING]
    ...
    <img width="490" height="490" alt="QR code for the v3.2-E2 CIA" src="https://github.com/EstebanPdN/zelda-alttp-3ds/releases/download/v3.2-E2/QR-v3.2-E2-github.png"
    />
    ...
    Press `L + R + A` while the issue is visible and attach the complete diagnostic
    dump folder from:
    ...
    '
  updated: '2026-09-13T03:55:09Z'
  version: v3.2-E2
  version_title: v3.2-E2
qr:
