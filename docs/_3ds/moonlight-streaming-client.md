...
downloads:
  moonlight.cia:
    size: 3947456
    size_str: 3 MiB
    url: https://github.com/zoeyjodon/moonlight-N3DS/releases/download/v1.1.1/moonlight.cia
...
update_notes: '<h2 dir="auto">Changelog</h2>
  ...
  <li>Fixes crash from pair file parsing</li>

  <li>Fixes config settings resetting</li>
  ...
  <p dir="auto"></p>'
updated: '2024-04-28T16:18:00Z'
version: v1.1.1
version_title: Moonlight 3DS v1.1.1
