...
update_notes: '<h2 dir="auto">Apparently a new update</h2>
  ...
  <li>Added a block for the home menu during the plugin menu to avoid freezes for
  stupid people (beta)</li>
