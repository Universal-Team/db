...
downloads:
  Balatro3DS.3dsx:
    size: 14150300
    size_str: 13 MiB
    url: https://github.com/idkhan/Balatro3DS/releases/download/v1.1.7-alpha/Balatro3DS.3dsx
...
update_notes: '<h3 dir="auto">Bugfixes:</h3>
  ...
  <li>Resized the Drag Zone for Use to prevent it from overlapping with the Consumables</li>

  <li>Fixed the Matador triggering for each time a debuffed card is selected</li>

  <li>Fixed the Vampire triggering for every card instead of just cards with an enhancement
  (wrote "or" instead of "and" oops)</li>

  <li>Fixed the Mark having cards be face down when opening Tarot cards. Now all Boss
  Effects are removed from The Shop.</li>

  </ul>

  <p dir="auto">Next Up - Full Gamepad Control and Localization.</p>'
updated: '2026-07-14T19:26:14Z'
version: v1.1.7-alpha
version_title: Alpha 1.1.7
---
