...
downloads:
  Balatro3DS.3dsx:
    size: 12455251
    size_str: 11 MiB
    url: https://github.com/idkhan/Balatro3DS/releases/download/v0.4.0-alpha/Balatro3DS.3dsx
...
- 3DS
title: Balatro3DS
update_notes: '<p dir="auto">WE HAVE SKIP TAGS!!!</p>

  <h3 dir="auto">Bugfixes</h3>

  <ul dir="auto">

  <li>Bigger Buy button</li>

  <li>Fixed the long delay in scoring with many jokers</li>

  <li>I can''t remember them all, there''s a bunch</li>

  </ul>'
updated: '2026-06-29T20:27:24Z'
version: v0.4.0-alpha
version_title: Alpha 0.4.0
---
