...
description: A simple Pokémon Blue/Red save editor for the 3DS.
...
update_notes: '<p dir="auto"><strong>Full Changelog</strong>: <a class="commit-link"
  ...
  <li>Test the modified save with an <strong>integrated emulator</strong></li>

  <li>Fixed bugs from previous versions and improved UI</li>
